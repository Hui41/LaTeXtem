...
\begin{example}[Hartogs]
  ...
  % \begin{figure}[h!]
  %   \centering
  %   \includegraphics[width=0.4\textwidth]{Hartogs.png}
  %   \caption*{Hartogs图}
  %   \end{figure}
...
% \begin{figure}[h!]
%   \centering
%   \includegraphics[width=0.4\textwidth]{Hartogs2.png}
...
\begin{definition}
  称 区域 $\Omega \subset \cc^n $ 上的一个``函数''  $f$ 为一个亚纯函数, 若 $f$ 局部可写为两个全纯函数的商. 记其全体为 $\mathcal{M} (\Omega )$.   
\end{definition}
...
\chapter{多次调和函数(plurisubharmonic)}
\section{上半连续函数}
